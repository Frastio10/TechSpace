...
//   return false;
 ...
 $('.notify-popup').click(function(event) {
 	$('.backdrop-popup').addClass('active');
 });

 $('.notify-close').click(function(event) {
 	$('.backdrop-popup').removeClass('active');
 });

 $('.img-hover').click(function(event) {
 	let source  = $(this).closest('.four').children('.img-data').attr('src');
